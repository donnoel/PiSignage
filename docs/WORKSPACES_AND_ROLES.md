...
and playlist assignment activity now use the session user ID as well. This does
not yet load real authenticated memberships from a login provider or expose
user-driven workspace switching.
